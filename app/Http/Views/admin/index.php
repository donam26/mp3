...
<html lang="en">
    ...
    <body>
                    ...
                    <li class="dropdown navbar-inverse">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            <li>
                                ...
                                <a href="#">
                                    <div>
                                        <i class="fa fa-comment fa-fw"></i> New Comment12311111111
                        ...
                        <ul class="nav" id="side-menu">
                            <li class="sidebar-search">
                                <div class="input-group custom-search-form">
                                    <input type="text" class="form-control" placeholder="Search/assets/admin.">
                            ...
                            <li>
                                <a href="index.html" class="active"><i class="fa fa-dashboard fa-fw"></i> Dashboar1d</a>
        ...
        <script src="/assets/admin/js/script-app.js"></script>
